...
app.controller('MainCtrl', ['$scope', '$http', 'uiGridConstants', function ($scope, $http, uiGridConstants) {
    ...
    */
    ...
    $scope.myData = [{name: "Moroni",age: 50,gender:"male"},
      {name: "Tiancum", gender:"male", age: 43},
      {name: "Jacob", gender:"male", age: 27},
      {name: "Nephi", gender:"female",age: 29},
      {name: "Enos", gender:"male", age: 34}];
